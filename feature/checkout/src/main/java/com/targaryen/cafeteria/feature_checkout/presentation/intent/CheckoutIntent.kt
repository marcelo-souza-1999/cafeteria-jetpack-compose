...
sealed interface CheckoutIntent {
    data class OnCepChanged(val cep: String) : CheckoutIntent
    data class OnNumberChanged(val number: String) : CheckoutIntent
    data class OnReferencePointChanged(val reference: String) : CheckoutIntent
    data class OnRecipientNameChanged(val name: String) : CheckoutIntent
    data object OnSearchAddressClicked : CheckoutIntent
    data object OnDismissCepModal : CheckoutIntent
    data class OnSearchReverseCep(val state: String, val city: String, val street: String) : CheckoutIntent
