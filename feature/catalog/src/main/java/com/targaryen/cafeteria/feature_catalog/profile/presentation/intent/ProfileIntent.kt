...
sealed interface ProfileIntent {
    ...
    data class UpdatePhoto(val photoUrl: String) : ProfileIntent
    data class UploadPhoto(val uri: Uri) : ProfileIntent
    data class ChangePassword(val currentPass: String, val newPass: String) : ProfileIntent
    data class ChangeName(val newName: String) : ProfileIntent
    data class ChangeEmail(val newEmail: String) : ProfileIntent
    ...
    data class ShowPurchaseDetail(val item: PurchaseHistoryItem) : ProfileIntent
