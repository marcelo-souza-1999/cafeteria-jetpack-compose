...
class CatalogRepositoryImplTest {
    ...
    @Test
    fun getProducts_shouldFetchFromLocalDaoAndMapToDomain() =
        runTest {
    ...
    @Test
    fun toggleFavorite_whenProductExists_shouldInvertFavoriteStatus() =
        runTest {
    ...
    @Test
    fun updateProductQuantity_shouldCallLocalDao() =
        runTest {
    ...
    @Test
    fun clearCart_shouldCallLocalDao() =
        runTest {
