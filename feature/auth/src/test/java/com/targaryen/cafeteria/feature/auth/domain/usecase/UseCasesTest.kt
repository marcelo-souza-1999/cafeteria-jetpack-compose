...
class UseCasesTest {
    ...
    @Test
    fun `SignInWithGoogleUseCase should delegate to repository`() = runTest {
        val token = "token"
    ...
    @Test
    fun `CheckAuthSessionUseCase should delegate to repository`() = runTest {
    ...
    @Test
    fun `SendPasswordResetEmailUseCase should delegate to repository`() = runTest {
